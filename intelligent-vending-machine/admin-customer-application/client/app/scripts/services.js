...
services.factory('poller', function poller($http, $timeout, $cookies) {

  poller.hasInternet = 0;

  var PartitionKey = $cookies.get('PartitionKey');
  console.log('Services PartitionKey set to '+ PartitionKey);
